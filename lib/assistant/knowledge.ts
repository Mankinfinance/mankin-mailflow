...
Templates: reusable email designs ("Start from the library" or "Saved by the team"). File manager: upload images for emails; always fill "Alt text — what a blocked image should say", because most email clients block images by default. "Copy snippet" copies the image for pasting into a body.
